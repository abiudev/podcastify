...
function ChipRootBase({
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, "data-open": open, className: styles, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChipContext.Provider, { value: contextValue, children }) }) : null;
}
