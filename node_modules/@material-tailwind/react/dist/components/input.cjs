...
function InputRootBase({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, "aria-disabled": disabled, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(InputContext.Provider, { value: contextValue, children }) });
}
...
var InputField = React2.forwardRef(InputFieldRoot);
