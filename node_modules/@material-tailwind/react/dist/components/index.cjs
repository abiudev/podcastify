...
function ChipRootBase({
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Component, { ...props, ref, "data-open": open, className: styles, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ChipContext.Provider, { value: contextValue, children }) }) : null;
}
...
function InputRootBase({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Component, { ...props, ref, className: styles, "aria-disabled": disabled, children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(InputContext.Provider, { value: contextValue, children }) });
}
...
function SliderRootBase({
  ...
  size ??= defaultProps?.size ?? "md";
  color ??= defaultProps?.color ?? "primary";
  const [uncontrolledValue, setUncontrolledValue] = React32.useState([0]);
